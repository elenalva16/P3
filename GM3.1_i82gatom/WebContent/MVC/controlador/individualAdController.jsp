...
<head>
<meta charset="UTF-8">
<title>Crear anuncio individualizado</title>
</head>
<body>
<%
		...
		String destinatario = request.getParameter("desAd");
		System.out.println(destinatario);
		
		String inicio = null;
		String fin = null;
		
		if (co.save(titulo, cuerpo, fecha, "Individualizado", propietario, inicio, fin)) {
			if(co.saveIndividualizado(destinatario))
			{
...
<%		} 
			...
			System.out.println("Error al crear anuncio individualizado");
