...
<head>
<meta charset="UTF-8">
<title>Crear anuncio temático</title>
</head>
<body>
<%	
		...
		int t = Integer.parseInt(request.getParameter("tagAd"));
		
		if (co.save(titulo, cuerpo, fecha, "Temático", propietario, inicio, fin)) 
		{
			if(co.saveTematico(t))
			{
	...
	<%
			...
			System.out.println("Error al crear anuncio tematico");
